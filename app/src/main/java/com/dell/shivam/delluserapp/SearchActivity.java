...
import com.dell.shivam.delluserapp.DataModels.MainProduct;
import com.dell.shivam.delluserapp.DataModels.StoreConfigModel;
import com.dell.shivam.delluserapp.utils.SearchResultAdapter;
                ...
                databaseReference.child("sell_in").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for(MainProduct mainProduct:mainProducts){
                            String storename=mainProduct.getStore_name();
